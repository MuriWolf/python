...
# e os dados armazenados em memória, caso sejam necessários, de forma a agilizar a execução do programa.
...
a=1# ESSE DESAFIO APARECE NOS EXERCICIOS DE ARQUIVOS,
b=1# ENT NAO VOU FAZER AGORA.